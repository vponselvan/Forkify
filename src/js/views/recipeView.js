...
const formatCount = count => {
    if (count) {
        count = Math.round((count + Number.EPSILON) * 10) / 10;
...
export const renderRecipe = (recipe, isLiked) => {
    ...
    const recipeHtml = `
        ...
        <div class="recipe__ingredients">
            ...
            <button class="btn-small recipe__btn shopping__add_btn">
...
export const updateServingIngredient = recipe => {
    ...
    //Ingredients
    const ArrCounts = Array.from(document.querySelectorAll('.recipe__count'));
    ArrCounts.forEach((el, i) => {
